...
class CommunitySales extends StatefulWidget {
  CommunitySales({Key key}) : super(key: key);

  @override
  _CommunitySalesState createState() => _CommunitySalesState();
}

class _CommunitySalesState extends State<CommunitySales> {
  bool _loading = true;
  @override

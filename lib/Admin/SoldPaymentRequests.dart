...
class SoldPaymentRequests extends StatefulWidget {
  @override
  _SoldPaymentRequestsState createState() => _SoldPaymentRequestsState();
}

class _SoldPaymentRequestsState extends State<SoldPaymentRequests> {
  bool _loading = true;
